...
***Samples***
```{r}
info<- read.csv(file = "P:/OEH/Faculty/hlehmler/research/Lehmler lab/Laura/RNAseq_Preg_Heatwave_Dam/novogene/01.RawData/fastq_files/BAM_files/RNASeq_bamlist_metadata.csv", #reading in the sample information
                   header = T, 
                   sep = ",")

filenames <- file.path("P:/OEH/Faculty/hlehmler/research/Lehmler lab/Laura/RNAseq_Preg_Heatwave_Dam/novogene/01.RawData/fastq_files/BAM_files/", 
                           info$bam_ID)
